...
#include <stddef.h>
#include "spazza_interfaces/msg/detail/pose__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  spazza_interfaces__msg__Pose__init(message_memory);
}

void Pose__rosidl_typesupport_introspection_c__Pose_fini_function(void * message_memory)
{
  spazza_interfaces__msg__Pose__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Pose__rosidl_typesupport_introspection_c__Pose_message_member_array[2] = {
  {
    ...
    offsetof(spazza_interfaces__msg__Pose, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(spazza_interfaces__msg__Pose, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Pose__rosidl_typesupport_introspection_c__Pose_message_members = {
  ...
  "Pose",  // message name
  2,  // number of fields
  sizeof(spazza_interfaces__msg__Pose),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, spazza_interfaces, msg, Pose)() {
