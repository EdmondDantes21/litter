...
#include <stddef.h>
#include "spazza_interfaces/msg/detail/position__rosidl_typesupport_introspection_c.h"
#include "spazza_interfaces/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  spazza_interfaces__msg__Position__init(message_memory);
}

void Position__rosidl_typesupport_introspection_c__Position_fini_function(void * message_memory)
{
  spazza_interfaces__msg__Position__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Position__rosidl_typesupport_introspection_c__Position_message_member_array[4] = {
  {
    ...
    offsetof(spazza_interfaces__msg__Position, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(spazza_interfaces__msg__Position, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(spazza_interfaces__msg__Position, z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(spazza_interfaces__msg__Position, theta),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Position__rosidl_typesupport_introspection_c__Position_message_members = {
  "spazza_interfaces__msg",  // message namespace
  "Position",  // message name
  4,  // number of fields
  sizeof(spazza_interfaces__msg__Position),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_spazza_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, spazza_interfaces, msg, Position)() {
