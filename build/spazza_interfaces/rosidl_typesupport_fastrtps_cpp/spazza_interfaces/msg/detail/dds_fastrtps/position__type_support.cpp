...
#include "spazza_interfaces/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const spazza_interfaces::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<spazza_interfaces::msg::Position *>(
    untyped_ros_message);
...
{
  return &spazza_interfaces::msg::typesupport_fastrtps_cpp::_Position__handle;
}
