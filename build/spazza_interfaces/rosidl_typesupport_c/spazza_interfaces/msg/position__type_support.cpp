...
#include "spazza_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Position_type_support_symbol_names_t _Position_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spazza_interfaces, msg, Position)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, spazza_interfaces, msg, Position)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_spazza_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, spazza_interfaces, msg, Position)() {
  return &::spazza_interfaces::msg::rosidl_typesupport_c::Position_message_type_support_handle;
}
